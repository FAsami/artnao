...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Yes, we offer international shipping to most countries. Shipping costs may apply.'
  },
  {
    question: 'What is your return policy?',
    answer:
      'We offer a 30-day return policy for most items. Please contact us for further details.'
  },
  {
    question: 'How can I contact customer support?',
    answer:
      'You can reach our customer support team via email at support@foysal.dev or through our contact form.'
  }
]
...
const FAQSection = () => {
  return (
    <div className="relative">
      ...
      <div className="container mx-auto pb-12 md:pb-48 relative">
        ...
        <div className="flex md:flex-row flex-col items-center justify-center gap-3 md:gap-12 ">
            ...
            >
              {faqItems.map((item, index) => (
                <Panel
                  ...
                  key={index}
                >
                  <p className="text-sm text-gray-500 pl-8">{item.answer}</p>
                </Panel>
              ))}
            </Collapse>
          </div>
        </div>
        <div className="blurry-light absolute right-0 top-20 -z-10 opacity-50"></div>
      </div>
    </div>
  )
}
